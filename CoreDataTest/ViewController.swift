...
//
    ...
    func generateRacesData2() -> [Race] {
        ...
        array.append(Race(1,"Australian Grand Prix 3","Albert Park March 23 – 25","Australian-Grand-Prix"))
        array.append(Race(2,"Bahrain Grand Prix 3 ","Bahrain International Circuit April 6 – 8","Bahrain-Grand-Prix"))
        array.append(Race(3,"Chinese Grand Prix 3","Shanghai International Circuit April 13 – 15","Chinese-Grand-Prix"))
        array.append(Race(4,"Azerbaijan Grand Prix 3","Baku City Circuit April 27 – 29","Azerbaijan-Grand-Prix"))
        array.append(Race(5,"Spanish Grand Prix 3","Circuit de Catalunya May 11 – 13","Spanish-Grand-Prix"))
        array.append(Race(6,"Monaco Grand Prix 3","Monaco May 24 – 27","Monaco-Grand-Prix"))
        array.append(Race(7,"Canadian Grand Prix 3","Circuit Gilles Villeneuve June 8 – 10","Canadian-Grand-Prix"))
        array.append(Race(8,"French Grand Prix 3","Paul Ricard June 22 – 24","French-Grand-Prix"))
        array.append(Race(9,"Austrian Grand Prix 3","Red Bull Ring June 29 – July 1","Australian-Grand-Prix"))
        array.append(Race(10,"British Grand Prix 3","Silverstone July 6 – 8","British-Grand-Prix"))
        array.append(Race(11,"German Grand Prix 3","Hockenheimring July 20 – 22","German-Grand-Prix"))
        array.append(Race(12,"Hungarian Grand Prix 3","Hungaroring July 27 – 29","Hungarian-Grand-Prix"))
        array.append(Race(13,"Belgian Grand Prix 3","Spa-Francorchamps August 24 – 26","Belgian-Grand-Prix"))
        array.append(Race(14,"Italian Grand Prix 3","Monza August 31 – September 2","Italian-Grand-Prix"))
        array.append(Race(15,"Singapore Grand Prix 3","Singapore September 14 – 16","Singapore-Grand-Prix"))
        array.append(Race(16,"Russian Grand Prix 3","Sochi Autodrom September 28 – 30","Russian-Grand-Prix"))
        array.append(Race(17,"Japanese Grand Prix 3","Suzuka October 5 – 7","Japanese-Grand-Prix"))
        array.append(Race(18,"United States Grand Prix 3","Circuit of the Americas October 19 – 21","United-States-Grand-Prix"))
        array.append(Race(19,"Mexican Grand Prix 3","Autodromo Hermanos Rodriguez October 26 – 28","Mexican-Grand-Prix"))
        array.append(Race(20,"Brazilian Grand Prix 3","Interlagos November 9 – 11","Brazilian-Grand-Prix"))
        array.append(Race(21,"Abu Dhabi Grand Prix 3","Yas Marina November 23 – 25","Abu-Dhabi-Grand-Prix"))
